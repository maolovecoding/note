...
**注意：以上方法是让块级元素水平居中，行内元素或者行内块元素水平居中给其父元素添加 <span style="color:red;">text-align:center</span> 即可。**
...
​		<span style="color:skyblue; font-weight:900;">注意：行内元素为了照顾兼容性，尽量只设置左右内外边距，不要设置上下内外边距。但是转换为块级和行内块元素就可以了。</span>
