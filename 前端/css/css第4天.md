<h1 style="color:red;" align=center> css第4天</h1>
...
CSS3 中新增了<span style="color:red;">盒子阴影</span>，我们可以使用 box-shadow 属性为盒子添加阴影。
语法：
...
注意：实际开发中，<span style="color:red;">一个页面基本都包含了这三种布局方式（后面移动端学习新的布局方式） 。</span>

### 2、标准流（普通流/文档流）

<span style="color:red;">所谓的标准流:  就是标签按照规定好默认方式排列</span>
...
3、<span style="color:red">浮动的元素会具有行内块元素的特性</span>
...
<span style="color:red">清除浮动的本质是清除浮动元素造成的影响：浮动的子标签无法撑开父盒子的高度</span>
...
​		<span style="color:red">额外标签法会在浮动元素末尾添加一个空的标签。</span>
